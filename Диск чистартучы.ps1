...
#GUI Variables
$FormTitleText = "Джим Тайлерның диск чистартучысы (PowerShellEngineer.com)"
$SelectDiskLabelText = "Дискны сайлагыз:"
$FreeSpaceLabelText = "Буш урын (гигабайт):"
$TotalSpaceLabelText = "Гомуми киңлек (гигабайт):"
$JunkFoundLabelText = "кирәксез әйберләр табылды (гигабайт):"
$CleanDiskBtnText = "Чиста диск * Файлларны бетерү *"
$SpaceCleanedLabelText = "Чистартылган урын (гигабайт):"
$LogFileLabelText = "Бүрәнә файллары табылды: $ abcdefg"
$CreditLabelText = "Джим Тайлер сценарие - PowerShellEngineer.com"
$LogFileLocatedText = "Керелгән файл табылды"
$AnalyzingDriveText = "Драйверларга анализ ..."
$BrowsersAreRunningText = "Браузерлар эшли ... Кулланучыга хәбәр итегез ..."
$PleaseCloseBrowsersText = "Зинһар, барлык веб-браузерларны ябып карагыз."
$CleaningDriveText = "Драйверны чистарту ..."
